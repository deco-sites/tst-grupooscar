  ...
  images: [
    {
      ...
      href: "/",
      mobile:
        "https://placehold.co/375x213",
      desktop:
        "https://placehold.co/1440x270",
    },
    {
      alt: "/feminino",
      href: "/",
  ...
  return (
    ...
    >
      <Image
        ...
        height={isMobile ? 213 : 270}
        class="object-cover w-full h-[calc(100vw*(213/375))] md:h-[calc(100vw*(270/1440))]"
      />
    </a>
  );
}
...
function LowBannerCarousel(props: Props) {
  const id = useId();
...
export default LowBannerCarousel;
